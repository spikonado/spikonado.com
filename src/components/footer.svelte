<script lang="ts">
	...
	import { marketingSectionOverlayClass, marketingSectionShellClass } from '@/styles/marketing';
...
>
	...
	>
		...
		<div class={columnBaseClass}>
			<a href="/" class="flex items-center gap-2 transition-transform duration-150 hover:scale-105">
		...
		<div class={columnBaseClass}>
			...
			<ul class="space-y-2">
				{#each companyLinks as link (link.label)}
					<li>
						<a href={link.path} class="text-foreground hover:text-muted-foreground">
							{link.label}
						</a>
					</li>
				{/each}
