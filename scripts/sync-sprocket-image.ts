...
export function compressToWebp(sourceImage: Uint8Array): Promise<Uint8Array> {
	return new Bun.Image(sourceImage).resize(FALLBACK_WIDTH).webp({ quality: WEBP_QUALITY }).bytes();
}
